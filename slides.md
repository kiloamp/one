...
| Task                 | Capability                   |  Device |
| -------------------- | ---------------------------------------- | --------------- |
| MCDU familiarisation | FMS / interface / systems                | FNPT II         |
...
2. Know what each training task requires.
...
<a class="cta" href="demo.html">Open</a>
